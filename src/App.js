...
function App() {
  ...
  return (
    <div className="App" style={{ position: 'relative', minHeight: '100vh', fontFamily: 'sans-serif' }}>
      ...
      {/* Main layout: grid + chat side by side */}
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', height: '100vh', overflow: 'hidden' }}>
                  ...
                  <React.Fragment key={`upload-row-${lessonIdx}`}>
                    ...
                    <label style={{
                      ...
                      <span style={{
                        ...
                        pointerEvents: 'none', whiteSpace: 'pre-line', display: 'block', lineHeight: 1.1,
                      }}>
        ...
        <div className="chat-panel" style={{
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '16px 14px', display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            {chatLoading && (
              <div style={{
                alignSelf: 'flex-start', background: '#2a2a4a', color: '#888',
          ...
          <form onSubmit={handleChatSubmit} style={{
            padding: '12px 14px', borderTop: '1px solid #333', background: '#16213e',
            display: 'flex', gap: 8,
          }}>
            <input
              type="text"
              ...
              style={{
                flex: 1, padding: '10px 14px', borderRadius: 20, border: '1px solid #444',
                background: '#2a2a4a', color: '#eee', fontSize: 13, outline: 'none',
              }}
            />
